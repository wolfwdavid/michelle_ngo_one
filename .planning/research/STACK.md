...
**Domain:** Creative portfolio / filmmaker website (static site with headless CMS)
...
```bash
# Scaffold project
npx sv create michelle-ngo-portfolio
...
export default {
  kit: {
    ...
    paths: {
      // Set to repo name if deploying to github.io/repo-name
      // Leave empty if using custom domain
...
**If using a custom domain (michellengo.net):**
- Set `paths.base` to empty string `''`
- Add CNAME file to `static/` directory
- Configure DNS to point to GitHub Pages

**If deploying to github.io/repo-name:**
...
**If Contentful free tier limits are hit:**
...
**If video embeds cause performance issues:**
...
For the roadmap -- these are the content types to define in Contentful:
...
---
*Stack research for: Creative portfolio / filmmaker website*
*Researched: 2026-05-07*
